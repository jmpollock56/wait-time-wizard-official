 ...
 */
const parks = [
  { id: 4, name: "Disneyland Park Paris", initial: "DPP" },
  { id: 5, name: "EPCOT", initial: "EPCOT" },
  { id: 6, name: "Magic Kingdom", initial: "MK" },
  { id: 7, name: "Hollywood Studios", initial: "HS" },
  { id: 8, name: "Animal Kingdom", initial: "AK" },
  { id: 16, name: "Disneyland", initial: "DL" },
  { id: 17, name: "California Adventure", initial: "CA" },
  { id: 28, name: "Walt Disney Studios Park", initial: "WDSP" },
  { id: 30, name: "Shanghai Disneyland", initial: "SHDL" },
  { id: 31, name: "Disneyland Hong Kong", initial: "DHK" },
  { id: 274, name: "Tokyo Disneyland", initial: "TDL" },
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.lands.length > 0) {
            parsedLands = await Promise.all(
              data.lands.map(async (land) => await parseWaitTimes(land))
            );
          } else {
            parsedLands = data.rides
          }
